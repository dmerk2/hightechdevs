...
<h2 style="text-align: center;">Site Analytics</h2>
<p style="text-align: justify;">Using this tool we can discover a variety of information. As one example, discovering the amount of people who viewed your website. Knowing this information will drastically improve your business.  This allows us to see where improvement is needed and to customize the SEO and website structure for total site optimization.</p>
...
<p style="text-align: justify;">We take the time, effort focus to make sure your website is completely customized to your business needs. Therefore, we are extremely attentive to detail leading to a website design that will <span style="color: #ff6600;"><strong>"pop" </strong></span>and bring your business to reach its full potential.</p>
[/cs_text][/cs_column][/cs_row][cs_row inner_container="false" marginless_columns="false" style="margin: 0px auto;padding: 0px;"][cs_column fade="false" fade_animation="in" fade_animation_offset="45px" fade_duration="750" type="1/3" style="padding: 0px;"][x_image type="none" src="http://cynthiaburnham.com/yahoo_site_admin/assets/images/handshake.87122244_std.jpg" alt="highly professional" link="false" href="#" title="" target="" info="none" info_place="top" info_trigger="hover" info_content="" style="height:235px;width: 100%;"][cs_text]
<h2 style="text-align: center;">Highly Professional</h2>
<p style="text-align: justify;">The <a href="http://www.hightechdevs.com/contact-us">High Tech Devs</a> team quickly responds to assure high quality service. We are always available for any question or anything else you need!</p>
...
<p style="text-align: justify;">Using WordPress, a very popular CMS (Content Management System), gives <em>you</em> the power to make routine changes (if needed). Wordpress was used to create <span style="color: #ff6600;">27%</span> of the current websites online as of February, 2017! Because of that, we are extremely skilled at working with Wordpress to stay up to date with current technology and design!</p>
...
<p style="text-align: justify;">Do you know that the Internet contributes to over $2.2 trillion in annual retail sales? High Tech Devs will develop an E-Commerce website accessible world wide.</p>
